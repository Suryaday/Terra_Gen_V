...
from dependency_overrides import apply_overrides
...
V2_raw, PROV = build_with_provenance(json.loads(SCHEMA.read_text(encoding="utf-8")))
V2 = apply_overrides(V2_raw)
...
with open(out, "w") as f:
    f.write("# AUTO-GENERATED (V3 precision) - DO NOT EDIT MANUALLY \n")
